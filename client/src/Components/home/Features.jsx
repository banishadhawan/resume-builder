...
const Featues = () => {
    ...
    return (
        ...
        <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 rounded-full px-6 py-1.5">
            <Zap width={14} />       {/*Zap is commonly an icon name from icon libraries. Zap represents a ⚡ lightning bolt icon.*/}
            <span>Simple Process</span>
        </div>
        
        <Title title='Build your resume' description='Our streamlined process helps
        you create a professional resume in minutes with intelligent
